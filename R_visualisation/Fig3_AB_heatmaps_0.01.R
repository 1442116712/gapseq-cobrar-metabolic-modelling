...
#
# Panel B: Substrate preference heatmap, full set (118 compounds)
#   - Reads single_all_substrates and pandraft_all_substrates
#     (already pre-filtered to Net_Growth >= 0.01 by the user).
#   - 118 compounds manually classified into 8 categories, shown
...
# Updated for 0.01 substrate-screen threshold (118 unique compounds in data)
compound_category <- c(
  # Amino acids (19): proteinogenic + non-proteinogenic gamma-amino acid
  ...
  # Other (19): cofactor artefacts, ROS, gases, aldehydes,
  # sulfonates, aromatic intermediates, bile acids, mucin glycans
